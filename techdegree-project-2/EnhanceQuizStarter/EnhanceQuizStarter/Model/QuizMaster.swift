...
class QuizMaster {
    ...
    struct TriviaQuestions {
        ...
        func retrieveAmountOfAnswers() -> Int {
    ...
    let questionNine = TriviaQuestions(
        question: "Array, set and ditionary are the three primary collection types",
        answerOne: "True",
        answerTwo: "False",
    ...
    init() {
        self.questionsCombined = [questionOne, questionTwo, questionThree, questionFour, questionFive, questionSix, questionSeven, questionEight, questionNine, questionTen, questionEleven]
    }
    ...
    */
    ...
    func provideQuestion() -> TriviaQuestions {
        let questionReturned = questionsCombined[questionsAsked]
    ...
    func checkAnswer(buttonPressed: Int) -> String {
        if (buttonPressed == 1 &&  questionsReorganised[questionsAsked].correctAnswer == 1) {
            ...
            questionsAsked += 1
            return "Yay!"
        } else if (buttonPressed == 2 &&  questionsReorganised[questionsAsked].correctAnswer == 2) {
            correctQuestions += 1
            questionsAsked += 1
            return "Yay!"
        } else if (buttonPressed == 3 &&  questionsReorganised[questionsAsked].correctAnswer == 3) {
            correctQuestions += 1
            questionsAsked += 1
            return "Yay!"
        } else if (buttonPressed == 4 &&  questionsReorganised[questionsAsked].correctAnswer == 4) {
                correctQuestions += 1
                questionsAsked += 1
                return "Yay!"
        } else {
